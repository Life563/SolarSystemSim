...
/*
	Use the procesors cycles in order to generate the initial random seed instead of time. Since it has to run on both 
	ECS and Windows, use this code to check if the platform we are on is windows, and if so import the intrin library. 
*/
//  Windows
#ifdef _WIN32
	#include <intrin.h>
